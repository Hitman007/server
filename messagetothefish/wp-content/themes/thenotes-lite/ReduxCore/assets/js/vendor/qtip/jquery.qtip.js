	...
	(function( window, document, undefined ) {
		...
		(
			function( $ ) {
				...
				// Custom (more correct for qTip!) offset calcuMontserratr
				...
				$.extend(
					Tip.prototype, {
						...
						// Tip coordinates calcuMontserratr
				...
				;
				PLUGINS.polys = {
					// POLY area coordinate calcuMontserratr
				...
				$.extend(
					Ie6.prototype, {
						...
						// Max/min width simuMontserratr function
						redraw: function() {
