...
class thenotes_lite_breadcrumb_class {
	...
	function thenotes_lite_custom_breadcrumb() {
		...
		echo '<li><a class="primary-color secondary-hover-color" href="'. esc_url(home_url('/')) .'">'. __('Home', 'thenotes-lite') .'</a></li>';
	...
	function thenotes_lite_simple_breadcrumb_case($der_post) {
		...
		if (is_page()) {
			...
			if ($der_post->post_parent) {
				...
				$link = '<a class="primary-color secondary-hover-color" href="';
		...
		if (is_month()) {
			...
			echo "<li><a class='primary-color secondary-hover-color' href='" . get_year_link($k_year) . "'>" . $k_year . "</a></li>" . $markup;
		...
		if (is_day() || is_time()) {
			...
			echo "<li><a class='primary-color secondary-hover-color' href='" . get_month_link($k_year, $k_month) . "'>" . $k_month_display . "</a></li>" . $markup;
