		...
		<div class="container">
			...
			<div class="row footer-copyright-wrapper">
				...
				<div class="col-md-6 col-sm-6 text-right">
					<span title="<?php bloginfo('name')?>"><?php printf( __( 'TheNotes Lite By %s', 'thenotes-lite' ), '<a class="footer-color"href="'.esc_url('https://sketchthemes.com').'"><strong>SketchThemes</strong></a>'
					); ?></span>
				</div>
			</div>
