...
?>
<style type="text/css">
.footer-color{color: <?php echo esc_attr($thenotes_lite_primary_color); ?>;}
...
/*FONT COLOR*/
span.slider_comments:hover,.post-slider-meta a:hover{color:<?php echo esc_attr($thenotes_lite_primary_color);?>}
