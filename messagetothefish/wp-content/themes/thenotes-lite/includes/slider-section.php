						...
						<?php while ( $the_query->have_posts() ) : $the_query->the_post(); ?>
							...
							<div class="item">
								<div class="post-slider-container">
									...
									<?php } ?>
									<div style="opacity: .95; border-radius: 25px; background: #73AD21;padding: 20px;">
									<div class="post-slider-title text-uppercase" ><a href = "<?php the_permalink();?>" style = "text-decoration: none !important;"/><?php echo wp_kses_post( $postTitle ); ?></div>
									</a></div>
									<div class="post-slider-sep"></div>
									<div class="post-slider-date post-slider-meta"><strong><?php _e('DATE', 'thenotes-lite'); ?></strong>: <?php echo get_the_date(); ?></div><div class="post-slider-metasep post-slider-meta">|</div><?php if ( has_tag() ) {
									...
									} ?><div class="post-slider-comment post-slider-meta"><strong><?php _e('COMMENTS', 'thenotes-lite') ?></strong>: <?php comments_popup_link(
									 __('POST A COMMENT', 'thenotes-lite'), 
									 __('1 COMMENT ', 'thenotes-lite'),
									  __('% COMMENTS ', 'thenotes-lite'),
									   'slider_comments', __('COMMENTS OFF ',
									    'thenotes-lite') ); ?></div>
								</div>
							</div>
						<?php endwhile; ?>
